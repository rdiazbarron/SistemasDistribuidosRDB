namespace WinFormsSereci
{
    public partial class Form1 : Form
    {
        ...
        {
            ServiceReference1.WebServiceSoapClient cert = new ServiceReference1.WebServiceSoapClient(
                new ServiceReference1.WebServiceSoapClient.EndpointConfiguration());
            ...
            {
                case 0:
                    ServiceReference1.CertificadoDefuncion certdef = cert.ObtenerCertificadoDefuncion(text1);
                    ...
                    break;
                case 1:
                    ServiceReference1.CertificadoMatrimonio certmat = cert.ObtenerCertificadoMatrimonio(text1);
                    ...
                    break;
                case 2:
                    ServiceReference1.CertificadoNacimiento certnac = cert.ObtenerCertificadoNacimiento(text1);
                    ...
                    break;
                case 3:
                    ServiceReference1.Persona datos = cert.ObtenerDatos(text1);
